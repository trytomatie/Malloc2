...
class Skill_BurnSlash : Skill
{
    ...
    /// </summary>
    public Skill_BurnSlash(float cooldown, float casttime,bool allowsMovement)
    {
        ...
        this.SpCost = 25;
        this.Image = ItemIcons.GetSkillIcon(10);
        this.Name = "Burn Slash";
        this.Description = "Deals damage" + Director.variableColorText + damage*100 + Director.colorEndText + "% Magicdamage over " + Director.variableColorText + duration + Director.colorEndText + " seconds.";
        this.FxMaterial = PublicGameResources.GetResource().fireMaterial;
    }
