...
class Skill_Rampart : Skill
{
    ...
    /// </summary>
    public Skill_Rampart(float cooldown, float casttime,bool allowsMovement)
    {
        ...
        this.Name = "Rampart";
        this.Description = "Increases your defence by " + Director.variableColorText + defenceIncrease + Director.colorEndText +" for " + Director.variableColorText + duration + Director.colorEndText + " seconds.";
        this.SpCost = 50;
    ...
    IEnumerator Cure(GameObject source)
    {
        ...
        source.GetComponent<Statusmanager>().ApplyStatusEffect(new StatusEffect_Rampart(defenceIncrease, duration));
        yield return new WaitForSeconds(0.4f);
